...
/* description: A single object is passed as reference from one thread to another at multiple levels. No Use After Scope as localVar is owned by taskLevel1
