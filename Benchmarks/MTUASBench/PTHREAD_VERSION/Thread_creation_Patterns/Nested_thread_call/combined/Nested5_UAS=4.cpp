...
/* Description: UAS=4 bugs mixed across all patterns.
   BUG 1 (nested deep pass): localVarA declared in taskLevel0A, passed to
          taskLevel5A via 5 levels. t1A joined in main — UAS.
   ...
   BUG 4 (spawn + join in main): localVarD and localVarE each passed to a
          separate thread from spawnD; both joined in main after spawnD returns — UAS.
*/
